...
public class TileMapBehaviourInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button(new GUIContent("Restore tileset", "Revert changed tileset properties"))) LoadTileset();
        if (GUILayout.Button(new GUIContent("Push tileset", "Save tileset properties to filesystem"))) SaveTileset();
    }
        ...
        if (!Application.isPlaying)
        {
            ...
            switch (m_tileMap.tileset)
            {
                ...
                case TilesetType.Mandala:
                    ...
                    break;
                case TilesetType.Tower:
                    animsPath = "Assets/Resources/GFX/Tilesets/Metadata/anims_tower.asset";
                    sheetPath = "Assets/Resources/GFX/Tilesets/Metadata/tiles_tower.asset";
                    break;
                case TilesetType.Tutorial:
                    animsPath = "Assets/Resources/GFX/Tilesets/Metadata/anims_tutorial.asset";
                    sheetPath = "Assets/Resources/GFX/Tilesets/Metadata/tiles_tutorial.asset";
                    break;
            }
            ...
            {
                EditorUtility.SetDirty(m_tileMap.TileSheet);
            }
            TilesetAnimsContainer tp = AssetDatabase.LoadAssetAtPath(animsPath, typeof(TilesetAnimsContainer)) as TilesetAnimsContainer;
            if (tp == null)
            {
                tp = CreateInstance<TilesetAnimsContainer>();
